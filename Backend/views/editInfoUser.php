        ...
        <div class="container">
            <div class="form-signin">
                ...
                <form method="post" id="formulario" enctype="multipart/form-data">
                    ...
                    <input type="number" id="inputId" class="form-control" value="<?php /*echo $_GET["userid_"];*/ echo $id; ?>" placeholder="<?php /*echo $_GET["Ind_"];*/ echo $id; ?>" readonly="readonly" required autofocus>
